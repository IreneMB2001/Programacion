...
public class Artículo {
  ...
  public String toString() {
    //String.format sirve para devolver una salida formateada, ya que no se puede devolver un System.out.printf
    return String.format("| %-7d | %-45s | %-10.2f€ | %-10.2f€ | %-5sunidades |", codArtículo, descripción, precioCompra, precioVenta, stockUnidades);
  }
}
